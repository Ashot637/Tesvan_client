export const translationsEn = {
  ...
  call: 'For more infotmation you can call +374 91 75 19 00',
...
export const translationsAm = {
  ...
  requiredPhone: 'Խնդրում ենք մուտքագրեք վավեր հեռախոսահամար',
  requiredEmail: 'Խնդրում ենք մուտքագրեք վավեր էլ․ հասցե',
  cart: 'Զամբյուղ',
  ...
  partner7: 'ARARAT BANK CJSC',
  partner8: 'ARMBUSINESS BANK CJSC',
  call: 'Մանրամասն տեղեկությւոնների համար կարող եք զանգահարել +374 91 75 19 00 հեռախոսահամարով։',
